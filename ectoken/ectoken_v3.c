...
int ec_encrypt(unsigned char* ao_ciphertext, int* ao_ciphertext_len,
...
int ec_decrypt(unsigned char* ao_plaintext, int* a_plaintext_len,
                          ...
                          const char* a_key, const int a_key_len)
{
    ...
    l_ret = ec_decrypt(l_token, &l_token_len, l_ciphertext, l_ciphertext_len,
                          ...
                          const char* a_key, const int a_key_len)
{
    ...
    l_ret = ec_encrypt(l_ciphertext, &l_ciphertext_len, l_tag,
