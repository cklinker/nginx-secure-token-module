...
static ngx_command_t ngx_http_secure_token_verizon_cmds[] = {
	...
	0,
	offsetof(ngx_secure_token_verizon_token_t, acl),
	NULL },
	...
	0,
	offsetof(ngx_secure_token_verizon_token_t, private_key),
	NULL },
...
static u_char*
ngx_encode_base64_verizon(u_char *d, ngx_str_t *src)
{
...
ngx_secure_token_verizon_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
	...
	{
		ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
			"\"private_key\" is mandatory for verizon tokens");
		return NGX_CONF_ERROR;
	}
